...
TOOL_REQUIREMENTS: tuple[ToolRequirement, ...] = (
    ...
    ToolRequirement(
        ...
        min_minor=98,
        gate="rust-extension",
        install_hint="Install Rust 1.98+ via `rustup toolchain install 1.98.0` or ensure `~/.cargo/bin` is on PATH.",
    ),
    ToolRequirement(
        name="Cargo",
        executable="cargo",
        ...
        min_minor=98,
        gate="rust-extension",
        install_hint="Install Cargo 1.98+ via `rustup toolchain install 1.98.0` or ensure `~/.cargo/bin` is on PATH.",
    ),
    ToolRequirement(
        name="Docker",
        executable="docker",
